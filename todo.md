# Project TODO
- [x] Scaffold the ASP.NET Core Web API and contractor credential domain model.
- [x] Implement credential submission and approval API workflows.
- [x] Add and run initial credential lifecycle unit tests.
